                ...
                <div className="kindword-sep">
                    ...
                    <div className="kindwords-buttons">
                        <div className="kindwords-detail">
                            <div className="kindword-name">
                                {props.data.name}
                            </div>
                            <div className="kindword-about">
                                {props.data.company}
                            </div>
                        </div>
                        <div className="kindwords-arrowbtns" id="about">
                            <div
                                className="kindwords-rightarrow arr-btn"
                                onClick={() => {
                                    props.HandleChangefuncdec();
                                }}
                            >
                                <i className="fa-solid fa-arrow-left-long"></i>
                            </div>
                            <div
                                className="kindwords-leftarrow arr-btn"
                                onClick={() => {
                                    props.HandleChangefuncinc();
                                }}
                            >
