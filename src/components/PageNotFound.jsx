...
function PageNotFound() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen">
            ...
            >
                {" "}
                <div className="absolute w-100  h-full -z-10 bg-[linear-gradient(45deg,rgba(58,29,245,1)_0%,rgba(90,82,255,1)_100%)] group-hover:w-100  transition-all duration-500"></div>
            ...
            <div
                className="w-10 h-10 -z-1 bg-blue-600 rounded-full animate-float blur-md absolute top-20 left-20"
                style={{ animationDelay: "1s" }}
            ></div>
            <div
                className="w-10 h-10 -z-1 bg-purple-600 rounded-full animate-float blur-md absolute bottom-20 left-40"
                style={{ animationDelay: "2s" }}
            ></div>
            <div
                className="w-10 h-10 -z-1 bg-blue-600 rounded-full animate-float blur-md absolute bottom-20 right-20"
                style={{ animationDelay: "1s" }}
            ></div>
        </div>
    );
